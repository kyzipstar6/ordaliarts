let trend =0; let rain = 0;let pressure = 1028;   let temp = 5;  
...
let inc1 =0.02; let inc2=0.01; let inc3= inc1*50; let inc4 =inc2*50;   
...
let ran = Math.random();let ran2 = Math.random();let ran3 = Math.random();let ran4 = Math.random();let ran5 = Math.random();  
    ...
    function main() {  
        ...
        if (hour > 10 && hour<18){ if(month ==6 || month==7 ){ temp=12.6;} if(month==6){ temp=10.2;}if( month==9){ temp=4,1;}  if(month ==4 ){temp=-14,3}
        if(month ==5 ){temp=-1}if(month ==3 ){temp=-26}
        if(month==10){ temp=-14.2;}if(month ==2 || month==1){ temp=-28.8;}if(month==12){ temp=-26.1;}if(month==11){ temp=-20.4;} }   
        if (hour < 10 || hour>18){ if(month ==6 || month==7 ){ temp=6.6;} if(month==8){ temp=3.2;}if( month==9){ temp=-1;}  if(month ==4 ){temp=4,6}
        if(month ==5 ){temp=-7,6}if(month ==3 ){temp=-31,2}
        if(month==10){ temp=-21.2;}if(month ==2 || month==1){ temp=-32.8;}if(month==12){ temp=-30.1;}  if(month==11){ temp=-27.4;}}  
       ...
       setInterval(() => {  
          ...
          if(minute<10)  document.getElementById("hour").innerText = `时间: ${hour}:0${minute}`;  
...
if (hum>100) hum =89
    ...
    function updateVariables(epoch){
        if(epoch.matches("now")){
            inc1 =0.02; inc2=0.01; hum=47;pressure=1027;
         if (hour > 10 && hour<18){ if(month ==6 || month==7 ){ temp=12.6;} if(month==6){ temp=10.2;}if( month==9){ temp=4,1;}  if(month ==4 ){temp=-14,3}
        if(month ==5 ){temp=-1}if(month ==3 ){temp=-26}
        if(month==10){ temp=-14.2;}if(month ==2 || month==1){ temp=-28.8;}if(month==12){ temp=-26.1;}if(month==11){ temp=-20.4;} }   
        if (hour < 10 || hour>18){ if(month ==6 || month==7 ){ temp=6.6;} if(month==8){ temp=3.2;}if( month==9){ temp=-1;}  if(month ==4 ){temp=4,6}
        ...
        if (year > 3100 && year <4000){temp = temp+3;}if (year > 4000 && year <4500){temp = temp-1;}
         ...
         if(epoch.matches("prepl")){
            inc1 =0.017; inc2=0.008;hum=67;pressure=1017;

           if (hour > 10 && hour<18){ if(month ==6 || month==7 ){ temp=22.6;} if(month==6){ temp=21.2;}if( month==9){ temp=17,1;}  if(month ==4 ){temp=0,3}
        if(month ==5 ){temp=12.1}if(month ==3 ){temp=-5.3}
        if(month==10){ temp=9.8;}if(month ==2 || month==1){ temp=-7.8;}if(month==12){ temp=-7.1;}if(month==11){ temp=-2.4;} }   
        if (hour < 10 || hour>18){ if(month ==6 || month==7 ){ temp=16.6;} if(month==8){ temp=17.2;}if( month==9){ temp=8.7;}  if(month ==4 ){temp=-4,6}
        if(month ==5 ){temp=2,6}if(month ==3 ){temp=-10,2}
        if(month==10){ temp=-1.2;}if(month ==2 || month==1){ temp=-14.3;}if(month==12){ temp=-15.1;}}  if(month==11){ temp=-9.4;}  
        if (year > -1 && year <1000){temp = temp-2;}if (year > 1000 && year <1300){temp = temp-4;} if (year > 1300 && year <1700) { temp = temp - 2; }  if (year > 1600 && year <1700){temp = temp-3;}  
        if (year > 1700 && year <1750){temp = temp-6;}if (year > 1750 && year <1920){temp = temp-5;}if (year > 1920 && year <1950){temp = temp-4;}if (year > 1950 && year <1980){temp = temp-3;}  
        if (year > 1980 && year <2000){temp = temp-2;}if (year > 2040 && year <2100){temp = temp+2;}if (year > 2100 && year <2200){temp = temp+4;}if (year > 2200 && year <2300){temp = temp+6;}  
        if (year > 2300 && year <2400){temp = temp+7;}if (year > 2400 && year <2600){temp = temp+6;}if (year > 2600 && year <3100){temp = temp+5;}  
        if (year > 3100 && year <4000){temp = temp+3;}if (year > 4000 && year <4500){temp = temp-1;}
         ...
         if(epoch.matches("cret")){
                        inc1 =0.014; inc2=0.007;hum=70;pressure=1010;

           if (hour > 10 && hour<18){ if(month ==6 || month==7 ){ temp=21.6;} if(month==6){ temp=19.2;}if( month==9){ temp=17,1;}  if(month ==4 ){temp=8,3}
        if(month ==5 ){temp=14.1}if(month ==3 ){temp=5.3}
        if(month==10){ temp=12.8;}if(month ==2 || month==1){ temp=2.8;}if(month==12){ temp=2.1;}if(month==11){ temp=5.4;} }   
        if (hour < 10 || hour>18){ if(month ==6 || month==7 ){ temp=17.6;} if(month==8){ temp=16.2;}if( month==9){ temp=14.7;}  if(month ==4 ){temp=4,6}
        if(month ==5 ){temp=8,6}if(month ==3 ){temp=0,2}
        if(month==10){ temp=7.8;}if(month ==2 || month==1){ temp=-1.3;}if(month==12){ temp=-2.1;}}  if(month==11){ temp=0.9;}  
        if (year > -1 && year <1000){temp = temp-2;}if (year > 1000 && year <1300){temp = temp-4;} if (year > 1300 && year <1700) { temp = temp - 2; }  if (year > 1600 && year <1700){temp = temp-3;}  
        if (year > 1700 && year <1750){temp = temp-6;}if (year > 1750 && year <1920){temp = temp-5;}if (year > 1920 && year <1950){temp = temp-4;}if (year > 1950 && year <1980){temp = temp-3;}  
        if (year > 1980 && year <2000){temp = temp-2;}if (year > 2040 && year <2100){temp = temp+2;}if (year > 2100 && year <2200){temp = temp+4;}if (year > 2200 && year <2300){temp = temp+6;}  
        if (year > 2300 && year <2400){temp = temp+7;}if (year > 2400 && year <2600){temp = temp+6;}if (year > 2600 && year <3100){temp = temp+5;}  
...
const nowBtn = document.getElementById("p-now");
const preplBtn = document.getElementById("p-2gyr");
const cretBtn = document.getElementById("p-4gyr");


function wire(){
    nowBtn.addEventListener("click", () => updateVariables("now"));
    preplBtn.addEventListener("click", () => updateVariables("prepl"));
    cretBtn.addEventListener("click", () => updateVariables("cret"));
}
