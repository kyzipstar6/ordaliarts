...
if (hum>100) hum =89;
    ...
    function tempM(){  
        ...
        if (hour > 10 && hour<18){ if(month ==1 || month==2){ temp=1;} if(month ==5 || month==8){ temp=18;}if(month ==4 || month==9){ temp=13;}  
        if(month ==3 || month==10){ temp=7;}if(month ==2 || month==11){ temp=3;}if(month ==1 || month==12){ temp=-1;}}  
        if (hour < 10 || hour>18){  if(month ==6 || month==7 ){temp=14;}if(month ==5 || month==8){ temp=14;} if(month ==4 || month==9){ temp=7;}  
        if(month ==3 || month==10){ temp=-1;}if(month ==2 || month==11){ temp=-4;}if(month ==1 || month==12){ temp=-5;}}  
    ...
    function boundSetter(){  
	    if (hour > 10 && hour<18){ if(month ==1 || month==2){ W_MAXmax =100;} if(month ==5 || month==8){ W_MAXmax =80;}if(month ==4 || month==9){ W_MAXmax =80;}  
        if(month ==3 || month==10){ W_MAXmax =100;}if(month ==2 || month==11){ W_MAXmax =91;}if(month ==1 || month==12){ W_MAXmax =102;}}  
...
function update(){
    if(hour>19 || hour<7) {  let aci = acumulator/36000;
